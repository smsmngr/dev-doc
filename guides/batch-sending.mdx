---
title: "Batch Message Sending: Up to 100 Recipients per Call"
sidebarTitle: "Batch Sending"
description: "Use SmsManager's /messages endpoint to send up to 100 messages per API call with different content, channels, recipients, and per-message callbacks."
---
