...
description: "Implement OTP-based phone number verification using SmsManager's Verify API, including code delivery, validation, and HMAC offline proof support."
---
