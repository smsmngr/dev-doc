---
title: "Send SMS: Senders, Unicode, and Gateways Explained"
sidebarTitle: "Send SMS"
description: "Step-by-step guide to sending SMS messages via SmsManager's JSON API v2, covering sender names, Unicode encoding, gateway selection, and TTL."
---
