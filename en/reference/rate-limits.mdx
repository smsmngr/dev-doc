...
<Tip>
  If you need to send very large volumes — thousands to hundreds of thousands of messages — upload a single JSONL file instead of making thousands of API calls; see [Bulk file upload via the REST API](/guides/batch-sending#bulk-file-upload-via-the-rest-api). For dedicated capacity, contact [SmsManager support](mailto:cc@smsmanager.cz).
</Tip>
