...
<AccordionGroup>
  <Accordion title="Invalid API key">
    ...
    **Fix:** Log in to [app.smsmanager.com/app/developers/apikeys](https://app.smsmanager.com/app/developers/apikeys) and copy your current API key. Pass it in every request using the `x-api-key` header:
