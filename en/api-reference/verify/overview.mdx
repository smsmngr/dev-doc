---
title: "Verify API — Phone Number OTP Validation Reference"
...
<CardGroup cols={3}>
  <Card title="Start Validation" icon="play" href="/en/api-reference/verify/start-validation">
    POST /v1/validations — initiate OTP delivery
  </Card>

  <Card title="Verify Code" icon="check" href="/en/api-reference/verify/verify-code">
    POST /v1/validations/{token}/verify — check the user's code
  </Card>

  <Card title="Verify Proof" icon="shield-check" href="/en/api-reference/verify/verify-proof">
