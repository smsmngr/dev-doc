...
<CardGroup cols={2}>
  <Card title="API Keys" icon="key" href="/en/api-reference/rest/api-keys">
    Create sub-keys, view key details, and configure callback URLs.
  </Card>

  <Card title="Credit" icon="coins" href="/en/api-reference/rest/credit">
    Check your prepaid credit balance in CZK and EUR.
  </Card>

  <Card title="Message Status" icon="message" href="/en/api-reference/rest/message-status">
    Query delivery status for individual messages and get daily sending statistics.
  </Card>

  <Card title="Inbox" icon="inbox" href="/en/api-reference/rest/inbox">
