...
You can find your API key in your [account settings](https://app.smsmanager.com/app/developers/apikeys). Keep your key private; anyone who holds it can send messages on your behalf.
...
<Note>
  **Use JSON API v2** (`https://api.smsmngr.com/v2`) for new integrations. The simpler [HTTP API](/en/api-reference/http-api/send) and [XML API](/en/api-reference/xml-api/send) remain permanently supported.
</Note>
