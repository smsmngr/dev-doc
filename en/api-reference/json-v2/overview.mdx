...
<CardGroup cols={2}>
  <Card title="POST /message" icon="message" href="/en/api-reference/json-v2/send-message">
    Send a single message object to up to 10 recipients with full flow, scheduling, and callback support.
  </Card>

  <Card title="POST /messages" icon="messages" href="/en/api-reference/json-v2/send-messages">
    Send a batch of up to 10 message objects in one HTTP call — up to 100 recipients per request.
  </Card>

  <Card title="Simple Message" icon="bolt" href="/en/api-reference/json-v2/send-simple-message">
    Send a single SMS via a plain GET URL or form-encoded POST — ideal for low-code tools and CRM integrations.
  </Card>

  <Card title="Webhooks" icon="webhook" href="/en/api-reference/json-v2/webhooks">
