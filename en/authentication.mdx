...
Log in to your SmsManager account and go to the [API & Cloud](https://app.smsmanager.com/app/developers/apikeys) page. Your primary API key is displayed there. Copy it and store it somewhere secure — you'll use it in every request you make to the API.
...
- **Rotate keys if compromised** — if you suspect a key has been leaked, create a new one immediately via [app.smsmanager.com/app/developers/apikeys](https://app.smsmanager.com/app/developers/apikeys) or the REST API, update your integrations, and delete the old key
