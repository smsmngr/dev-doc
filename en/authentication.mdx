...
You can create and manage sub-keys programmatically through the [REST API](/en/api-reference/rest/api-keys). Sub-keys are useful when you run multiple integrations or services and want to track usage or revoke access independently.
