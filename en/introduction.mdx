...
1. **Get your API key** — log in to [app.smsmanager.com/app/developers/apikeys](https://app.smsmanager.com/app/developers/apikeys) and copy your key. You can also create scoped sub-keys through the REST API.
