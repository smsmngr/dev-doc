...
<CardGroup cols={2}>
  ...
  <Card title="AI skills" icon="wand-magic-sparkles" href="/ai/skills">
    Install verified SmsManager API knowledge into Claude Code, Cursor or Codex.
  </Card>

  <Card title="MCP server" icon="plug" href="/ai/mcp-server">
    Connect an AI assistant to your account — sending, delivery status, keys, credit and services.
  </Card>
</CardGroup>