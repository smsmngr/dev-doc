...
<Tip>
  An AI agent can write the webhook endpoint for you: the `smsmanager-delivery-reports` skill from the [SmsManager skills](/ai/skills) package knows the payload format, the status sequence and the `result_info` codes described on this page.
</Tip>
