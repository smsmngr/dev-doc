...
<Note>
  Potřebujete odeslat **více než 100 příjemců najednou**? Použijte hromadné nahrání JSONL souboru přes REST API (`POST /messaging/url`, viz [REST API](/api-reference/rest/overview)). Skill `smsmanager-bulk-messaging` z balíčku [SmsManager skills](/ai/skills) umí soubor vygenerovat, nahrát a naplánovat za vás.
</Note>
