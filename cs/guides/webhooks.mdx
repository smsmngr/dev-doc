...
<Tip>
  Webhook endpoint vám může napsat AI agent: skill `smsmanager-delivery-reports` z balíčku [SmsManager skills](/ai/skills) zná formát payloadu, sekvenci stavů i kódy `result_info` popsané na této stránce.
</Tip>
