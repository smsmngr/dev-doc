...
Sub-klíče můžete programově vytvářet a spravovat přes [REST API](/cs/api-reference/rest/api-keys). Sub-klíče jsou užitečné, pokud provozujete více integrací nebo služeb a chcete sledovat využití nebo nezávisle odvolávat přístup.
