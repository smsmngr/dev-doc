...
Když SmsManager posílá oznámení o doručení na vaši [callback URL](/api-reference/json-v2/webhooks), payload obsahuje `message_id` doručené zprávy. Porovnejte tuto hodnotu s ID, které jste uložili při odeslání, a aktualizujte své vlastní záznamy o doručení.
