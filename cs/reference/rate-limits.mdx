...
<Tip>
  Pokud potřebujete odesílat velmi velké objemy — tisíce až statisíce zpráv — nahrajte místo tisíců API volání jeden JSONL soubor; viz [Hromadné nahrání souboru přes REST API](/guides/batch-sending#hromadné-nahrání-souboru-přes-rest-api). Pro vyhrazenou kapacitu kontaktujte [podporu SmsManager](mailto:cc@smsmanager.cz).
</Tip>
